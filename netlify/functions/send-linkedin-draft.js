...
exports.handler = async (event) => {
  ...
  try {
    ...
    const post = `This week's top professional events in the UAE:\n\n${lines.join('\n')}\n\nBrowse all events → ${SITE_URL}\n\n#DubaiEvents #UAE #ProfessionalNetworking #Conferix`;
...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:24px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        <tr><td style="background:linear-gradient(135deg,#0B1426,#1C2333);padding:24px;border-radius:12px 12px 0 0;text-align:center;">
          <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;">Conferix <span style="color:#D4A853;">UAE</span></p>
    ...
    await resend.emails.send({
      ...
      subject: `LinkedIn Draft — UAE Events This Week (${formatDate(todayStr)})`,
      html: emailHtml,
    });
