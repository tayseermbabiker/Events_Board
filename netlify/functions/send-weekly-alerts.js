...
const SITE_URL = process.env.SITE_URL || 'https://conferix.com/uae';
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:linear-gradient(135deg,#0B1426,#1C2333);padding:32px 24px;border-radius:12px 12px 0 0;text-align:center;">
          <p style="margin:0;font-size:24px;font-weight:700;color:#ffffff;">Conferix <span style="color:#D4A853;">UAE</span></p>
        ...
        <tr><td style="background:#f8fafc;padding:24px;border-radius:0 0 12px 12px;text-align:center;border-top:1px solid #e2e8f0;">
          <p style="margin:0 0 8px;font-size:13px;color:#94a3b8;">You're receiving this because you subscribed to Conferix UAE alerts.</p>
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const subject = `This Week's UAE Events — ${formatDate(mondayStr)} to ${formatDate(sundayStr)}`;
    ...
    for (const sub of subscribers) {
      ...
      const citiesPref = sub.get('cities') || 'All Emirates';
      ...
      const allCities = cityList.some(c => c === 'All Emirates');
