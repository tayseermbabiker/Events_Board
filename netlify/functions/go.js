...
<head>
  ...
  <title>${title} — Conferix UAE</title>
    ...
    <tr><td align="center">
      <table width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;">
        ...
        <tr><td style="background:linear-gradient(135deg,#0B1426,#1C2333);padding:20px 24px;border-radius:12px 12px 0 0;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td><a href="${SITE_URL}" style="font-size:20px;font-weight:700;color:#ffffff;text-decoration:none;">Conferix <span style="color:#D4A853;">UAE</span></a></td>
        ...
        <tr><td style="background:#f8fafc;padding:20px 24px;border-radius:0 0 12px 12px;text-align:center;border-top:1px solid #e2e8f0;">
          <p style="margin:0;font-size:13px;color:#94a3b8;"><a href="${SITE_URL}" style="color:#64748b;text-decoration:underline;">conferix.com/uae</a> — Professional events in the UAE</p>
        </td></tr>
